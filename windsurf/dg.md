...
- **Distributed systems:** Missing retries/backoff, no idempotency, no circuit breakers, hand-rolled workflows or pub/sub masquerading as orchestration — a self-respecting distributed system needs a real orchestrator ([Conductor](https://github.com/conductor-oss/conductor)), not event choreography and hope. Race conditions, no timeouts on network calls, ignored partial failures
